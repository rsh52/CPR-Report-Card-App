...
ui <- fluidPage(
  ...
  column(12,
         sidebarPanel(
           ...
           numericInput(inputId = "epochwin", label = "Input Epoch Window Interval", value = 30, min = 10),
           width = 12
  ...
  mainPanel(
    tabsetPanel(
      ...
      tabPanel(
        ...
        h1("User Information", align = "center"),
        ...
        h3("Data Calculation Methodoloy", align = "left"),
        ...
        p("   ", span("- For <1 year olds, target guidelines are 3.6 to 4.6 cm.")),
        p("   ", span("- For 1 - <8 year olds, target guidelines are 4.6 to 5.6 cm.")),
        p("   ", span("- For 8 - <18 year olds, target guidelines are 5 to 6 cm.")),
        ...
        h4("Epoch Calculations", align = "left"),
