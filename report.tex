...
\begin{flushright}\includegraphics{report_files/figure-latex/unnamed-chunk-1-1} \end{flushright}
...
Total CCs (n) & 9743\\
\hline
Total Time of Event (min) & 111.17\\
\hline
\end{tabular}
    }{\caption{CCF Table}}
  \end{floatrow}
...
\hline
 & Percentage\\
\hline
Compressions in Target Depth: & 25\%\\
\hline
Compressions in Target Rate: & 83\%\\
\hline
\end{tabular}
